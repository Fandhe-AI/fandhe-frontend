...
fn reduced_motion_block_redefines_rolling_text_transition() {
    ...
    assert!(
        before.contains(r#"[data-part="rolling-text-current"] > [data-part="rolling-text-char"],"#)
    );
