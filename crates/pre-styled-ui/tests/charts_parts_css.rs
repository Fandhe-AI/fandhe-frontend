...
fn tooltip_css_matches_golden_fixture_byte_for_byte() {
    ...
    let expected = concat!(
        ...
        "}\n",
        "\n",
        // イシュー #2131: indicator バリアント（`Dot`/`None` は class を
        // 持たないため golden に現れない、モジュール doc「indicator
        // バリアント」節参照）。
        "[data-scope=\"chart\"][data-part=\"tooltip-item\"].fd-chart--indicator-line {\n",
        "  align-items: stretch;\n",
        "}\n",
        "\n",
        "[data-scope=\"chart\"][data-part=\"tooltip-item\"].fd-chart--indicator-dashed {\n",
        "  align-items: stretch;\n",
        "}\n",
        "\n",
        "[data-scope=\"chart\"][data-part=\"tooltip-indicator\"].fd-chart--indicator-line {\n",
        "  width: 1px;\n",
        "  height: auto;\n",
        "  border-radius: 0;\n",
        "}\n",
        "\n",
        "[data-scope=\"chart\"][data-part=\"tooltip-indicator\"].fd-chart--indicator-dashed {\n",
        "  width: 0;\n",
        "  height: auto;\n",
        "  background: transparent;\n",
        "  border: 1.5px dashed var(--fandhe-chart-tooltip-color, currentColor);\n",
        "  border-radius: 0;\n",
        "}\n",
        "\n",
        ...
        "}\n",
        "\n",
        // イシュー #2131: hover 強調（減光・拡張）の起点。wasm-full 側の
        // `data-has-active` 付け外し配線は未実装だが、CSS 自体は末尾純追加
        // する（モジュール doc「hover 強調」節参照）。
        "[data-scope=\"chart\"][data-part=\"frame\"][data-has-active] {\n",
        ...
        "}\n",
        "\n",
        "[data-scope=\"chart\"][data-part=\"datum\"][data-active] {\n",
        "  opacity: 1;\n",
