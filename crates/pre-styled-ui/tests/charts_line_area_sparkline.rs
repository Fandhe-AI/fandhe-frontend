...
fn line_chart_single_category_matches_golden_html() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            r#"<circle data-scope="line-chart" data-part="point" cx="150" cy="75" r="2.5" fill="var(--fandhe-color-chart-1)" data-index="0" data-series="visits"></circle><rect x="0" y="0" width="300" height="150" data-scope="chart" data-part="hit-area" data-index="0" fill="none" pointer-events="none" tabindex="-1" aria-label="only · visits: 7">"#,
            r#"</rect></svg><div data-scope="chart" data-part="tooltip-layer" aria-hidden="true"><div data-scope="chart" data-part="tooltip" data-index="0" hidden="">"#,
...
fn line_chart_dots_and_value_label_matches_golden_html() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            r#"<path data-scope="line-chart" data-part="series-line" d="M0,150 L150,20 L300,85" stroke="var(--fandhe-color-chart-1)" fill="none" data-series="visits"></path><circle data-scope="line-chart" data-part="point" cx="0" cy="150" r="2.5" fill="var(--fandhe-color-chart-1)" data-index="0" data-series="visits">"#,
            r#"</circle><circle data-scope="line-chart" data-part="point" cx="150" cy="20" r="2.5" fill="var(--fandhe-color-chart-1)" data-index="1" data-series="visits"></circle><circle data-scope="line-chart" data-part="point" cx="300" cy="85" r="2.5" fill="var(--fandhe-color-chart-1)" data-index="2" data-series="visits">"#,
            r#"</circle><text x="0" y="138" data-scope="line-chart" data-part="value-label" text-anchor="middle" data-index="0" data-series="visits">10</text><text x="150" y="8" data-scope="line-chart" data-part="value-label" text-anchor="middle" data-index="1" data-series="visits">"#,
            r#"30</text><text x="300" y="73" data-scope="line-chart" data-part="value-label" text-anchor="middle" data-index="2" data-series="visits">20</text><rect x="0" y="20" width="75" height="130" data-scope="chart" data-part="hit-area" data-index="0" fill="none" pointer-events="none" tabindex="-1" aria-label="Jan · visits: 10">"#,
