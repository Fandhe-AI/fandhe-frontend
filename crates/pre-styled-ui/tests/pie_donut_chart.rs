...
fn pie_chart_renders_expected_d_attributes_for_known_data() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            r#"<path data-scope="pie-chart" data-part="segment" d="M50,50 L50,5 A45,45,0,0,1,88.97,72.5 Z" fill="var(--fandhe-color-chart-1)"></path><path data-scope="pie-chart" data-part="segment" d="M50,50 L88.97,72.5 A45,45,0,0,1,27.5,88.97 Z" fill="var(--fandhe-color-chart-2)">"#,
            r#"</path><path data-scope="pie-chart" data-part="segment" d="M50,50 L27.5,88.97 A45,45,0,0,1,11.03,27.5 Z" fill="var(--fandhe-color-chart-3)"></path><path data-scope="pie-chart" data-part="segment" d="M50,50 L11.03,27.5 A45,45,0,0,1,50,5 Z" fill="var(--fandhe-color-chart-4)">"#,
            ...
            r#"<div data-scope="chart" data-part="tooltip-label">Q2</div><div data-scope="chart" data-part="tooltip-item" data-series="revenue"><span data-scope="chart" data-part="tooltip-indicator" style="--fandhe-chart-tooltip-color: var(--fandhe-color-chart-1)" aria-hidden="true">"#,
            ...
            r#"<div data-scope="chart" data-part="tooltip-label">Q3</div><div data-scope="chart" data-part="tooltip-item" data-series="revenue"><span data-scope="chart" data-part="tooltip-indicator" style="--fandhe-chart-tooltip-color: var(--fandhe-color-chart-1)" aria-hidden="true">"#,
            ...
            r#"<div data-scope="chart" data-part="tooltip-label">Q4</div><div data-scope="chart" data-part="tooltip-item" data-series="revenue"><span data-scope="chart" data-part="tooltip-indicator" style="--fandhe-chart-tooltip-color: var(--fandhe-color-chart-1)" aria-hidden="true">"#,
...
fn donut_chart_renders_expected_d_attributes_for_known_data() {
    ...
    assert_eq!(
        ...
        concat!(
            ...
            r#"<path data-scope="donut-chart" data-part="segment" d="M50,5 A45,45,0,0,1,88.97,72.5 L73.38,63.5 A27,27,0,0,0,50,23 Z" fill="var(--fandhe-color-chart-1)">"#,
            r#"</path><path data-scope="donut-chart" data-part="segment" d="M88.97,72.5 A45,45,0,0,1,27.5,88.97 L36.5,73.38 A27,27,0,0,0,73.38,63.5 Z" fill="var(--fandhe-color-chart-2)">"#,
            r#"</path><path data-scope="donut-chart" data-part="segment" d="M27.5,88.97 A45,45,0,0,1,11.03,27.5 L26.62,36.5 A27,27,0,0,0,36.5,73.38 Z" fill="var(--fandhe-color-chart-3)">"#,
            r#"</path><path data-scope="donut-chart" data-part="segment" d="M11.03,27.5 A45,45,0,0,1,50,5 L50,23 A27,27,0,0,0,26.62,36.5 Z" fill="var(--fandhe-color-chart-4)">"#,
