...
//! [`crate::text`](mod@crate::text) のような独立した styled 部品を組み合わせてもよい）に
...
//!   側の変更を要する。代わりに [`crate::text`](mod@crate::text)（独立した styled 部品）を
...
//! `width`/`height` が 0 のため不可視（[`crate::tabs`](mod@crate::tabs) のルートレベル
