...
/// - dialog/drawer/menu/select/combobox/popover/tooltip の `[data-part="positioner"]` を
///   `position: static` へ中和: recipe CSS は dialog/drawer を
...
/// accordion/dialog/drawer/menu/select/combobox/popover/tooltip/switch/
