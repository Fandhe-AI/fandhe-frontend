...
/// バイト、全体の約 99.7%。設計文書 §10-12）。イシュー #2865
/// （`pricing-seats-split` block 追加）で実測が 1,704,017 バイトへ達し
/// 再度超過したため、本定数を 4000 → 3968 へ再度引き下げて対処した
/// （実測 1,695,144 バイト、全体の約 99.5%。設計文書 §10-13）。
