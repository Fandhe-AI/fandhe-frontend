...
/// セクションの拡充（イシュー #2730 配下の並行 PR 群）が進み、本 PR
/// （イシュー #2817 `careers-split-photo-list`）の base 取り込み後に
/// 実サイトが 1,313,136 バイトへ達し、この上限（1,310,720 バイト）を
/// 約 2,416 バイト超過したため、同じ +131,072 バイト刻みで 1.375 MiB
/// （`1_048_576 + 393_216`）へ引き上げた（設計文書 §10-4/§10-5 参照）。
