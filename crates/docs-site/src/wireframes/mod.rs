...
/// 「レイアウト骨格」の [`divider::WIREFRAME`]（イシュー #2612）が続いた。
/// Phase 1〜8（#2608〜#2665）の残りの各部品イシューが自分の [`Wireframe`]
/// 定数を 1 要素ずつ追記する。
pub const WIREFRAMES: &[Wireframe] = &[annotation::WIREFRAME, divider::WIREFRAME];
