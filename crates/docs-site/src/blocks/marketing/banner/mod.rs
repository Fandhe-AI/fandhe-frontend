...
//! 2 番目の block（`banner_email_signup`）・イシュー #2739 で
//! `banner_announcement_pill`・イシュー #2742 で `banner_floating_card`・
//! イシュー #2743 で `banner_full_width_bar` を追加し、`footer/mod.rs` と
...
pub(super) fn blocks() -> Vec<Block> {
    vec![
        banner_announcement_pill::BLOCK,
