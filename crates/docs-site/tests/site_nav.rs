...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // （Phase 8 の 2 番目の部品）が加わり、294 → 295 になった。
    ...
    // Image（Phase 8 の 2 番目の部品）が加わり 43 件になった。
