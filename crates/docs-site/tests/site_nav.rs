...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // イシュー #2661 で Wireframes セクションへ Media 部品ページ（Phase 8
    // 「Media・データ表示」の 3 番目の部品）が加わり、296 → 297 になった。
    ...
    // 加わり 44 件になった。イシュー #2661 で Media（Phase 8「Media・
    // データ表示」の 3 番目の部品）が加わり 45 件になった。
