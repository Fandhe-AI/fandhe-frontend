...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // 253 → 254 になった。イシュー #2612 で Wireframes セクションへ
    // Divider 部品ページが加わり、254 → 255 になった。
    ...
    // 加わり 2 件になった。イシュー #2612 で Divider が加わり 3 件になった。
    ...
    assert_eq!(
        ...
        3,
        "expected 3 /wireframes/ pages (index + annotation + divider), got {wireframes_pages:?}"
    );
    assert!(
