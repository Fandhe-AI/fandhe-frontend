...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // display」の 2 番目の部品）が加わり 39 件になった。イシュー #2656 で
    // Stat（Phase 7「Data display」の 3 番目の部品）が加わり 40 件になった。
