...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // （Phase 8「Media・データ表示」の 2 番目の部品）が加わり、
    // 294 → 295 になった。
    ...
    // データ表示」の最初の部品）が加わり 42 件になった。イシュー #2661 で
    // Media（Phase 8「Media・データ表示」の 2 番目の部品）が加わり
    // 43 件になった。
