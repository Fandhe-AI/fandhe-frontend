...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // イシュー #2657 で Wireframes セクションへ List 部品ページ
    ...
    // が加わり 38 件になった。イシュー #2657 で List（Phase 7「Data
