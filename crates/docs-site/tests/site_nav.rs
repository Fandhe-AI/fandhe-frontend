...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // イシュー #2656 で Wireframes セクションへ Stat 部品ページ
    // （Phase 7「Data display」の 2 番目の部品）が加わり、290 → 291 になった。
    ...
    // が加わり 38 件になった。イシュー #2656 で Stat（Phase 7「Data
