...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // #2662 で Wireframes セクションへ Table 部品ページ（同 Phase の
    // 3 番目の部品）が加わり、295 → 296 になった。
    ...
    // #2662 で Table（同 Phase の 3 番目の部品）が加わり 44 件になった。
