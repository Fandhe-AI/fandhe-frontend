...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // イシュー #2658 で Wireframes セクションへ Card basic 部品ページ
    // （Phase 7「Data display」の 5 番目の部品）が加わり、293 → 294 に
    // なった。
    ...
    // 加わり 41 件になった。イシュー #2658 で Card basic（Phase 7
    // 「Data display」の 5 番目の部品）が加わり 42 件になった。
