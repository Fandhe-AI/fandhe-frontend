...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // （Phase 7「Data display」の部品）が加わり、290 → 291 になった。
    ...
    // が加わり 38 件になった。イシュー #2658 で Card basic
    // （Phase 7「Data display」の部品）が加わり 39 件になった。
