...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // イシュー #2660 で Wireframes セクションへ Image 部品ページ
    // （Phase 8「Media・Data」の最初の部品）が加わり、293 → 294 に
    // なった。
