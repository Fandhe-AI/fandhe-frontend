...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // 加わり 41 件になった。イシュー #2662 で Table（Phase 8
    // 「Media・Data」の最初の部品）が加わり 42 件になった。
