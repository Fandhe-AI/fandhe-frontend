...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // ページ（Phase 7「Data display」の 4 番目の部品）が加わり、
    // 292 → 293 になった。
    ...
    // イシュー #2658 で Card basic（Phase 7「Data display」の 4 番目の部品）
    // が加わり 41 件になった。
