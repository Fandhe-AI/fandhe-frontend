...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // なった。イシュー #2664 で Wireframes セクションへ Map 部品ページ
    // （Phase 8 の chart に続く部品）が加わり、294 → 295 になった。
    ...
    // データ表示」の最初の部品）が加わり 42 件になった。イシュー #2664 で
    // Map（Phase 8 の chart に続く部品）が加わり 43 件になった。
