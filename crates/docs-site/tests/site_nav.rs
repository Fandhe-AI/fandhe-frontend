...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // イシュー #2654 で Wireframes セクションへ Emoji 部品ページ
    ...
    // が加わり 38 件になった。イシュー #2654 で Emoji（Phase 7「Data
