...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // 「Media・データ表示」の 3 番目の部品）が加わり、295 → 296 になった。
    ...
    // #2661 で Media（Phase 8「Media・データ表示」の 3 番目の部品）が
    // 加わり 44 件になった。
