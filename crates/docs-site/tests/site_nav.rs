...
fn site_nav_registers_all_pages_with_expected_paths() {
    ...
    // なった。イシュー #2662 で Wireframes セクションへ Table 部品ページ
    // （同 Phase の 2 番目の部品）が加わり、294 → 295 になった。
    ...
    // データ表示」の最初の部品）が加わり 42 件になった。イシュー #2662 で
    // Table（同 Phase の 2 番目の部品）が加わり 43 件になった。
