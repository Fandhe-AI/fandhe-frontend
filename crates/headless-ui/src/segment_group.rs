    ...
    fn full_assembly_root_with_indicator_and_two_items() {
        ...
        assert_eq!(
            ...
            concat!(
                ...
                r#"<input data-scope="segment-group" data-part="item-hidden-input" type="radio" value="list" data-state="checked" name="view" checked=""></input>"#,
                ...
                r#"<input data-scope="segment-group" data-part="item-hidden-input" type="radio" value="grid" data-state="unchecked" name="view"></input>"#,
