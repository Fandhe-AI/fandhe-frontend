...
/// [`crate::menu::MENU_CSS`]・イシュー #2639 で
/// [`crate::breadcrumbs::BREADCRUMBS_CSS`]・イシュー #2644 で
...
/// [`crate::stat::STAT_CSS`]（4 番目の部品）・イシュー #2660 で
/// [`crate::image::IMAGE_CSS`]（Phase 8「Media・Data」の最初の部品）・
/// イシュー #2663 で [`crate::chart::CHART_CSS`]（同 Phase の 2 番目の
/// 部品）・イシュー #2662 で [`crate::table::TABLE_CSS`]（同 Phase の
/// 3 番目の部品）が続いた。
pub const PARTS: &[&str] = &[
    ...
    crate::menu::MENU_CSS,
    crate::breadcrumbs::BREADCRUMBS_CSS,
