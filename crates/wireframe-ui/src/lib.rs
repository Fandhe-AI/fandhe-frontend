...
//! として消費）・[`input`]（イシュー #2622、`props::Active` と
//! `props::Disabled` を併用する 3 例目の部品）が続いた。残りは Phase 1
//! の他部品（frame）・Phase 2 の他部品（text/paragraph/tag 等）および
//! Phase 3 の他部品（textarea/radio/slider）以降（#2608〜）で順次追加する。
//!
//! # class 命名規約
//!
