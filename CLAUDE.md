...
├── wasm-full/     # fandhe-frontend-wasm-full: CSR/ハイドレーション フルセット（配線群別 feature 16 件 + scope feature 16 件 + 別枠 feature〔position/stagger/animate〕3 件、既定 on、#2326/#2327/#2398。`default-features = false` 利用者の移行手順は `docs/guides/wasm-full-features.md`）
