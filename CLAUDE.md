...
│   ├── ci/                   # CI・runner 運用（ci-runner-requirements / perf-browser-harness / cargo-semver-checks-evaluation / version-bump-publish-order-gap / a11y-automation-evaluation / docs-site-interaction-testing-evaluation〔docs サイト対話操作検証手段の導入評価、#1084〕 / example-overlay-browser-interaction-testing-evaluation〔example オーバーレイのブラウザ実インタラクションテスト常設 CI 化評価、#1210〕）
