...
│   ├── ci/                   # CI・runner 運用（ci-runner-requirements / perf-browser-harness / cargo-semver-checks-evaluation / version-bump-publish-order-gap / a11y-automation-evaluation / docs-site-interaction-testing-evaluation〔docs サイト対話操作検証手段の導入評価、#1084〕）
