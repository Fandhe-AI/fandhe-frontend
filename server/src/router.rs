...
//! 製品化したものである。マッチング仕様は `docs/router-path-matching.md`
//! （TASK-7.2a）で確定済みであり、本モジュールはその仕様どおりに実装
//! している。仕様と実装に乖離が生じた場合は `docs/router-path-matching.md`
...
//! # マッチング仕様（v1）
//!
//! 詳細は `docs/router-path-matching.md` を参照。要点は以下のとおり。
//!
...
//!   ディスパッチは v1 のスコープ外（`docs/router-path-matching.md` §4 参照）。
//!
//! # セキュリティ不変条件
//!
