...
styled ラッパー追加（#829、`tree_view` #753 の派生）・Calendar/DatePicker
styled ラッパー追加（#835、親トラッキング #832、`docs/design/component-coverage-map.md`
保留解除。いずれも公開時点未反映）を経て 82 の公開モジュールを持つ。
内訳は次の通り。
