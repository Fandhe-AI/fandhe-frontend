...
checkbox styled ラッパー追加（#730）・PasswordInput styled ラッパー追加
（#740、v0.7.0 未公開）を経て 21 の公開モジュールを持つ。内訳は次の通り。
...
| headless ラッパー第 6 弾 | `password_input` | #740（`src/password_input.rs` 冒頭 rustdoc 参照） |
