...
## 2. 実装状況（v0.13.0 時点、2026-07-23 更新）
...
styled ラッパー追加（#755）・Carousel styled ラッパー追加（#754）・Link/
LinkOverlay/NavList styled ラッパー追加（#756）・HoverCard styled ラッパー
追加（#759、いずれも公開時点未反映）を経て 42 の公開モジュールを持つ。
内訳は次の通り。
