...
ラッパー追加（#828）・Marquee 静的部品追加（#831、
`docs/policy/intentional-non-adoption.md` §3.24 の意図的非採用を再導入、
いずれも公開時点未反映）を経て 79 の公開モジュールを持つ。内訳は次の通り。
