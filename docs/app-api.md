...
本書は `docs/component-api.md`（TASK-5.1a）と同じ書式（ステータス・
...
`docs/dependency-graph-policy.md`）に対し、PoC-3 実測値は 52 件/深さ 5
...
## 8. `docs/component-api.md` との整合確認

- 本書第 4 節・判断 1（コンポーネントは通常の Rust 関数）は
  `docs/component-api.md` 第 2 節の標準規約と矛盾しない。
