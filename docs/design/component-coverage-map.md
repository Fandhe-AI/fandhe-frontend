...
| `.agents/skills/ark-ui/references/components/form/rating-group.md` | RatingGroup | Rating | — | — | `rating_group` | `rating_group` | 実装済み | headless+styled 実装済み（#742）。イシュー #1617 で `RatingGroupProps` 新設・control/label `data-*`・roving tabindex 追加 |
...
| `.agents/skills/chakra-ui/references/components/forms/rating.md` | RatingGroup | Rating | — | — | `rating_group` | `rating_group` | 実装済み | headless+styled 実装済み（#742）。イシュー #1617 で `RatingGroupProps` 新設・control/label `data-*`・roving tabindex 追加 |
