...
`text-animation` feature（0.34.0 で追加、イシュー #2532）は `scroll-driver`/
...
| 0.34.0 | `text-animation` feature（イシュー #2532、typewriter/scramble 配線）。あわせて `fandhe-frontend-animation` の依存 version 要求を 0.11.0 → 0.12.0 へ追随した |
